...
#codigo para mudar a escala do grafico dependendo da frequencia para ficar mais bonito
if frequencia > 200:
...
# Títulos
plt.title(f"Onda senoidal — {frequencia:.2f} Hz | f(t) = sen(2π * {frequencia:.2f} * t)")
plt.xlabel("Tempo (ms)")
